 ...
 *
 */
public class TencentRelationManager implements IRelationManager<TencentAppClient,String,String>{

	private static final Log logger = LogFactory.getLog(TencentRelationManager.class);
	
	TencentAppClient appClient;
	ICache<String,String> relationCache;
	
	@Override
	public void setAppClient(TencentAppClient appClient) {
